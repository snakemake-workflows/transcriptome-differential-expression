...
def rule_all_input():
    ...
    all_input.append("de_analysis/dispersion_graph." + config["deseq2"]["figtype"])
    all_input.append("de_analysis/ma_graph." + config["deseq2"]["figtype"])
    all_input.append("de_analysis/heatmap." + config["deseq2"]["figtype"])
